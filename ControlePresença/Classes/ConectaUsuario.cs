...
namespace ControlePresença
{
    class ConectaUsuario
    {
        ...
        public void RestauraDigital(Usuario us)
        {
            try
            {
                conexao = new MySqlConnection(Endereco());
                conexao.Open();
                string alterar = "UPDATE presenca SET digital='' WHERE cod = '" + us.Codigo + "'";
                MySqlCommand comandos = new MySqlCommand(alterar, conexao);
                comandos.ExecuteNonQuery();
                conexao.Close();
            }
        ...
        public DataTable faltaApinista(Usuario us)
        {
            try
            {
                conexao = new MySqlConnection(Endereco());
                conexao.Open();
                string selecionar = "SELECT nome, dtCad FROM presenca WHERE nome='"+us.Nome+"'";
                MySqlDataAdapter comandos = new MySqlDataAdapter(selecionar, conexao);
                DataTable dt = new System.Data.DataTable();
                comandos.Fill(dt);
                conexao.Close();
